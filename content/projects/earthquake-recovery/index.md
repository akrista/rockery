---
title: Earthquake Recovery & Rebuild
date: 2026-07-21
tags:
  - projects
  - logs
...
On June 24, 2026, a significant earthquake struck Venezuela, causing structural damage to my home. This page serves as a public log to document the recovery, repairs, and rebuilding efforts.

## 📋 Context & Damage Assessment

### Apartment Reconstruction Scope

- **Wall Demolition**: Severe damage requires knocking down (_tumbar_) 7 partition walls inside our apartment.
- **Plumbing Repairs**: A broken water pipe inside one of the damaged walls has been capped (_clausurado_). Work is currently underway to route and install the new replacement pipeline.
- **Renovations**: General remodeling, plastering, and masonry repairs are being carried out across the apartment.

### Building-Wide Engineering Scope

- **Elevator Inspections**: Coordinate with certified technicians to inspect and verify elevator safety.
...
You can browse all photos and video documentation of the earthquake damage and ongoing reconstruction work in the shared Immich folder:

- **Immich Shared Album**: [Full Earthquake & Recovery Photo Gallery](https://img.notakrista.com/share/GSo_F5qPUSIJyJ99ZT7j2xQYIlbDnlTrAfczL8ZMkqR75FSVHrQcy4Vj0CynHcc1yBU)

## 📅 Rebuild Updates & Daily Logs
...
- **[[daily/2026/06/2026-06-24-venezuela-earthquake|2026-06-24]]** — The earthquake occurred, causing structural damages to my home.
...
El 24 de junio de 2026, un terremoto significativo sacudió a Venezuela, causando daños estructurales en mi hogar. Esta página sirve como una bitácora pública para documentar la recuperación, reparaciones y esfuerzos de reconstrucción.

## 📋 Contexto y Evaluación de Daños

### Alcance de la Reconstrucción del Apartamento

- **Demolición de Paredes**: Los daños severos requieren tumbar 7 paredes divisorias dentro de nuestro apartamento.
- **Reparaciones de Plomería**: Se clausuró una tubería de agua rota dentro de una de las paredes afectadas. Actualmente se trabaja en la canalización e instalación de la nueva tubería de reemplazo.
- **Remodelaciones**: Reparaciones generales de remodelación, mampostería y yeso en todo el apartamento.

### Alcance de Ingeniería a Nivel del Edificio

- **Inspección de Ascensores**: Coordinar con técnicos certificados para inspeccionar y verificar la seguridad de los ascensores.
...
Puedes explorar todas las fotos y la documentación en video de los daños del terremoto y los trabajos de reconstrucción en la carpeta compartida de Immich:

- **Álbum Compartido de Immich**: [Galería Completa de Fotos del Terremoto y Recuperación](https://img.notakrista.com/share/GSo_F5qPUSIJyJ99ZT7j2xQYIlbDnlTrAfczL8ZMkqR75FSVHrQcy4Vj0CynHcc1yBU)

## 📅 Actualizaciones y Bitácora Diaria
...
- **[[daily/2026/06/2026-06-24-venezuela-earthquake|2026-06-24]]** — Ocurrió el terremoto, causando daños estructurales en mi hogar.
